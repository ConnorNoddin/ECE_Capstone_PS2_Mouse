...
private:
  ...
  void controller::get_xy(int16_t x, int16_t y)
  {
      _x = x;
      _y = y;
  }

  void controller::get_xy_dist(int16_t x_dist, int16_t y_dist)
  {
      _x_dist = x_dist;
      _y_dist = y_dist;
  ...
  void controller::get_squal(uint16_t s)
  {
      _squal = s;
      //print_squal_lcd();
  }

  void controller::get_fault()
  {
      Serial.println("XY_LASER is shorted to GND");
      //_lcd.print("FAULT");
  }

  uint16_t controller::get_x()
  {
      return _x_dist;
      //_lcd.print("FAULT");
  }

  uint16_t controller::get_y()
  {
      return _y_dist;
      //_lcd.print("FAULT");
  }
